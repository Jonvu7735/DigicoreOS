//! crm-svc entrypoint.
//!
//! Responsibilities (ARCHITECTURE.md §3.3): customers, contacts, deals, sales
//! pipeline, activities. Boot order: load config -> init observability -> wire
...
// domain slices (customers, deals, ...) fill in without restructuring.
#![allow(dead_code)]
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing::info!(%addr, "crm-svc listening");
    ...
    tracing::info!("crm-svc shut down cleanly");
    Ok(())
}
