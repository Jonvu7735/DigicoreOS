//! Environment-based configuration for reporting-svc.
//!
...
pub const SERVICE_NAME: &str = "reporting-svc";
...
pub struct AppConfig {
    ...
    /// Dedicated schema; this service owns ONLY `reporting_svc`.
...
/// JWT verification settings. Reporting only VERIFIES the tokens auth-svc issues,
...
impl AppConfig {
    pub fn from_env() -> anyhow::Result<Self> {
        ...
        Ok(Self {
            ...
            env: env.clone(),
            http_port: env_or("HTTP_PORT", "8085")
                .parse()
            ...
            database_schema: env_or("DATABASE_SCHEMA", "reporting_svc"),
