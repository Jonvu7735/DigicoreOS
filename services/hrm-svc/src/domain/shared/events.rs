//! Convert a domain `HrmEvent` into an outbox message (header + JSON payload).

use event_models::hrm::HrmEvent;
use platform_outbox::OutboxMessage;

use crate::domain::shared::error::{DomainError, DomainResult};

pub fn outbox_message(event: &HrmEvent) -> DomainResult<OutboxMessage> {
