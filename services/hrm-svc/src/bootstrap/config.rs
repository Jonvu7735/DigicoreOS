//! Environment-based configuration for hrm-svc.
//!
...
pub const SERVICE_NAME: &str = "hrm-svc";
...
pub struct AppConfig {
    ...
    /// Dedicated schema; this service owns ONLY `hrm_svc`.
...
/// JWT verification settings. HRM only VERIFIES the tokens auth-svc issues, so
...
impl AppConfig {
    pub fn from_env() -> anyhow::Result<Self> {
        ...
        Ok(Self {
            ...
            env: env.clone(),
            http_port: env_or("HTTP_PORT", "8084")
                .parse()
            ...
            database_schema: env_or("DATABASE_SCHEMA", "hrm_svc"),
