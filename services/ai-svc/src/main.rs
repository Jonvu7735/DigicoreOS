//! ai-svc entrypoint.
//!
//! Responsibilities (ARCHITECTURE.md §3.6): the platform AI kernel — insights,
//! scoring, RAG/assist. Boot order: load config -> init observability -> wire
...
// insight engine + event consumer slices fill in without restructuring.
#![allow(dead_code)]
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing::info!(%addr, "ai-svc listening");
    ...
    tracing::info!("ai-svc shut down cleanly");
    Ok(())
}
