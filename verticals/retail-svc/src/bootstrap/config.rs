//! Environment-based configuration for retail-svc.
//!
...
pub const SERVICE_NAME: &str = "retail-svc";
...
pub struct AppConfig {
    ...
    /// Dedicated schema; this vertical owns ONLY `retail_svc`.
...
impl AppConfig {
    pub fn from_env() -> anyhow::Result<Self> {
        ...
        Ok(Self {
            ...
            env: env.clone(),
            http_port: env_or("HTTP_PORT", "8088")
                .parse()
            ...
            database_schema: env_or("DATABASE_SCHEMA", "retail_svc"),
